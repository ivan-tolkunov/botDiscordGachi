...
WORDS = {"соси" : [None, "Sam sosi XD"],
         ...
         "penetration" : ["8 differet Penetrationsounds.wav", ""],
         "anal" : ["Anal.wav", ""],
         "see" : ["Do you like what you see.mp3", ""],
         "dungeon" : ["Dungeon master.mp3", ""],
         "300" : ["Fisting is 300.mp3", ""],
         "fuck" : ["FUCK YOU.wav", ""],
         "slaves" : ["Fuckin Slaves.wav", ""],
         "deep" : ["It's so fucking deep.mp3", ""],
         "cum" : ["Make me cum.wav", ""],
         "sorry" : ["Oh Shit Im Sorry.wav", ""],
         "for" : ["Sorry for what.wav", ""],
         "cumming" : ["Ooouuuuh Im fucking cumming.wav", ""],
         "finger" : ["Stick your finger.mp3", ""],
         "swallow" : ["Swallow my cum.mp3", ""],
         "boy" : ["Take it boy.mp3", ""],
